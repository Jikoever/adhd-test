...
const translations = {
  zh: {
    ...
    saveHint: "💡 输入邮箱并点击邮件里的登录链接，即可保存你的进度和历史记录",
    choosePlan: "选择你的版本",
    free: "免费",
    perMonth: "/月",
    recommended: "推荐",
  ...
  en: {
    ...
    saveHint: "💡 Enter your email and use the sign-in link from your inbox to save progress and history",
  ...
  es: {
    ...
    saveHint: "💡 Escribe tu correo y usa el enlace del inbox para guardar tu progreso e historial",
